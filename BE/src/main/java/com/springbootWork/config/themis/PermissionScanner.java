package com.springbootWork.config.themis;

import com.springbootWork.config.themis.annotation.*;
...
public class PermissionScanner {
    public Permission scan(Method method) {
        ...
        } else if (getAnnotation(method, Consumer.class) != null) {
            return new Permission(UserType.CONSUMER);
